...
const COMMON_PHRASES: Array<[RegExp, string]> = [
  ...
  [/\b(?:pinch|pinsj|pintsj)\b/g, "pintje"],
  [/\bdoen\s+maar\b/g, "doe maar"],
  [/\been\s+tweede\s+dubbel(?:e|en)?\b/g, "een tweede duvel"],
  [/\btweede\s+dubbel(?:e|en)?\b/g, "tweede duvel"],
  [/\bnog\s+een\s+dubbel(?:e|en)?\b/g, "nog een duvel"],
  [/\bextra\s+dubbel(?:e|en)?\b/g, "extra duvel"],
